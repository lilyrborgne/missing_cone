...
AI Disclosure: this code was written by **Claude haiku** using a prompt that explained the equations and asked for an implementation of an interactive qz/qx plot. 
